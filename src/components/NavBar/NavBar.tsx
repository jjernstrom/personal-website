  ...
  return (
    <Stack direction="row" margin="auto" gap={4}>
      <Link href="https://github.com/jjernstrom" display="flex">
        <img src={GitHubIcon} height={24} width={24} style={{ margin: 'auto' }} />
        <Typography color="#ebdbb2" margin="auto" marginLeft={1}>
          GitHub
        </Typography>
      </Link>
      <Link href="https://www.linkedin.com/in/jeffrey-jernstrom/" display="flex">
        <img src={LinkedInIcon} height={24} width={24} style={{ margin: 'auto' }} />
        <Typography color="#ebdbb2" margin="auto" marginLeft={1}>
          LinkedIn
        </Typography>
      </Link>
        ...
        <Container maxWidth="lg">
          <Stack direction="row" display="flex" flexWrap="wrap" rowGap={5}>
            <Stack direction="row" display="flex" flexWrap="wrap" columnGap={5}>
              <Typography variant="h4" color="#ebdbb2" margin="auto" fontFamily="Courier New">
                jjernstrom
              </Typography>
              <SocialMediaBar />
            </Stack>
            <Stack gap={4} direction="row" justifyContent="right" marginLeft="auto">
